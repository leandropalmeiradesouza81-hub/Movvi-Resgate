...
function registerView() {
  ...
  d.querySelector('#rf').onsubmit = async (e) => {
    ...
    try { const u = await Auth.registerClient({ name: d.querySelector('#rn').value, email: d.querySelector('#re').value, phone: d.querySelector('#rph').value, vehicleModel: d.querySelector('#rv').value, password: p }); saveUser(u); initApp(); }
